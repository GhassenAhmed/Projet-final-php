...
<body>
    ...
    <div class="main-content">
            <div class="p-3 header_admin " style='background:#fff;'> 
                ...
                <div class="float-end">
            <h3><span class="user"><i class="fa-solid fa-user"></i></span><?= $_SESSION['utilisateur']?><img src="../../authentification/upload/<?= $_SESSION['photo']?>" width="55px" height="55px" style='border-radius:50%;margin-left:2rem;'></img></span></h3>
            </div>
    </div> 
        <div class="main p-5 ">
            <main>
